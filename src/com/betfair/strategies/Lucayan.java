...
//			persister.persistRunner(r3);
	...
	private List<Runner> getRunners(MarketBook marketBook){
	...
	private Order generateOrderObject(PlaceInstruction instruction, Double price, Double size, Double expReturn){
